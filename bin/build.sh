...
# Argument #2: Go program path to build, "as/camscan/camscan.go" assumed when not defined
build_path="${2:-as/camscan/camscan.go}"
...
do
   ...
   do
     ...
     go build -trimpath -C "$root_path" -o "$output_path" "$build_path"
